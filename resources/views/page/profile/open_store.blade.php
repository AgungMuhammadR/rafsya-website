            ...
            <div class="store-date" style="padding-left: 358px">
                ...
                <div class="form-group mt-4" style="width: 400px">
                    ...
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" name="license" id="licenseFile"
                            style="color: #1ACBAA;">
                        <label class="custom-file-label" for="licenseFile" id="license">Choose file</label>
                    </div>
                </div>
            </div>

            <div class="mb-3 mb-m-1 order-md-1 text-md-center">
                <button type="submit" class="btn mt-5 mb-4 btn-lg pl-5 pr-5" id="Checkout">Buat Toko</button>
            </div>
